...
const { Address, networks } = require('bcoin');
...
const bech32prefixes = {
  main: networks.main.addressPrefix.bech32,
  testnet: networks.testnet.addressPrefix.bech32,
  regtest: networks.regtest.addressPrefix.bech32,
  simnet: networks.simnet.addressPrefix.bech32
};
